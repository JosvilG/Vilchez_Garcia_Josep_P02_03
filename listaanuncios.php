...
print "<h5><a href=listaanunciosS.php> Click para ver todos los articulos disponibles </a></h5>";
...
$consulta = "SELECT $dbTabla1.id, $dbTabla1.titulo, $dbTabla1.precio, $dbTabla3.nombre, $dbTabla2.nombre AS usuarios FROM $dbTabla1, $dbTabla2, $dbTabla3 WHERE $dbTabla1.categoria=$dbTabla3.id AND $dbTabla1.propietario=$dbTabla2.email AND $dbTabla1.vendido='NO' ORDER BY fechahora DESC";
